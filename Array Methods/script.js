...
const products = [
  ...
  { name: 'Headphone', price: 49 },
  { name: 'Smartwatch', price: 199 },
  { name: 'Speakers', price: 75 },
];
...
const users = [
  ...
  { id: 2, name: 'Jane', age: 35, isActive: true },
  { id: 3, name: 'Mike', age: 40, isActive: false },
  { id: 4, name: 'Emily', age: 28, isActive: false },
  { id: 5, name: 'David', age: 32, isActive: true },
];
...
//-----// Search and Find First Element: find() //-----//
...
const books = [
  ...
  { title: 'Physics', author: 'Martin' },
  { title: 'Engineering', author: 'John' },
];
...
//-----// Handle Nested Arrays: flat() and flatMap() //-----//
...
const doubleArray = numbers.flatMap(number => [number, number * 2]);
